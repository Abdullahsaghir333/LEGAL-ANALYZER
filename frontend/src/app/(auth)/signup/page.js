          ...
          <div className="max-w-md mx-auto">
            ...
            <form className="mt-8 space-y-5" onSubmit={(e) => e.preventDefault()}>
              ...
              <label className="flex items-start gap-3 cursor-pointer group">
                <input type="checkbox" className="mt-0.5 w-4 h-4 text-primary rounded border-outline-variant/40 focus:ring-primary/20" />
              ...
              {/* Submit */}
              <Link href="/dashboard" id="signup-submit"
                className="w-full py-3 px-6 bg-primary text-on-primary font-medium text-sm rounded-lg shadow-primary hover:opacity-90 active:scale-[0.98] transition-all flex items-center justify-center gap-2">
                Create Account
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="py-3 px-4 bg-surface-container-lowest border border-outline-variant/40 rounded-lg text-sm font-medium text-on-surface-variant hover:bg-surface-container-low transition-all flex items-center justify-center gap-2">
