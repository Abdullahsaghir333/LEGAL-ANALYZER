    ...
    try {
      ...
      if (res.ok) {
        ...
        if (data.role === "lawyer" || data.role === "admin") {
          ...
          router.push("/client/explore-lawyers");
        }
      } else {
          ...
          <div className="w-full max-w-[440px] mx-auto">
            ...
            <div className="space-y-3">
              <div className="flex flex-col gap-2">
                <label htmlFor="google-role" className="text-[11px] font-bold text-on-surface-variant uppercase tracking-wider">
                ...
                <div className="relative">
                  ...
                  <select 
                    ...
                    className="w-full pl-10 pr-10 py-2.5 bg-surface-container-low border border-outline-variant/40 rounded-lg text-sm text-on-surface appearance-none focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
                  >
